...
window.isSearchBot = !1,
        ...
        function o(t) {
            ...
            if (n > 300 && n > i) {
                ...
                n > 1e3 && (n += 100), console.log("auto correct cover height: " + n), o.find(".t-cover").height(n), o.find(".t-cover__filter").height(n), o.find(".t-cover__carrier").height(n), o.find(".t-cover__wrapper").height(n), 0 == $isMobile && setTimeout(function() {
                    ...
                    e.find("iframe").length > 0 && (console.log("correct video from cover_fixcontentheight"), a(e, n + "px"))
                }, 2e3)
            }
        }
        ...
        t.prototype.defaultConfig = {
            ...
            e(document).ready(function() {
                ...
                if (v.length && v.load(function() {
                    ...
                    if ("" != d || "" == c && "" == l) {
                        if ("" != d) {
                            n.css("background-color", "#000000"), n.css("background-image", "");
                            var g, w = 0,
                                m = e(window);
                            m.scroll(function() {
                        ...
                        if (n.css("background-color", "#000000"), n.css("background-image", "url('https://tilda.ws/img/spinner-white.gif')"), n.css("background-size", "auto"), "" != h) var y = !1;
                        else var y = !0;
                        if ("" != u) var b = 1;
                        else var b = "";
                        var x = "";
    ...
    function(e) {
        e(document).ready(function() {
            ...
            e("body").height() < e(window).height() - 100 && e(".t-tildalabel").css("display", "none")
        })
    }(jQuery),
    function(e) {
        function t() {
    ...
    function(e) {
        e.fn.videoBG = function(t, o) {
            ...
            var i = e(this);
            if (i.length) {
                "static" != i.css("position") && i.css("position") || i.css("position", "relative"), 0 == o.width && (o.width = i.width()), 0 == o.height && (o.height = i.height());
                var n = e.fn.videoBG.wrapper();
                n.height(o.height).width(o.width), o.textReplacement ? (o.scale = !0, i.width(o.width).height(o.height).css("text-indent", "-9999px")) : n.css("z-index", o.zIndex + 1);
                var r = e.fn.videoBG.video(o);
                return o.scale && (n.height(o.height).width(o.width), r.height(o.height).width(o.width)), i.html(n), i.append(r), r.find("video")[0]
            }
            ...
            var i = e("<video/>");
            if (i.css("position", "absolute").css("z-index", t.zIndex).attr("poster", t.poster).css("top", 0).css("left", 0).css("min-width", "100%").css("min-height", "100%"), t.autoplay && i.attr("autoplay", t.autoplay), t.volume > 0 ? i.prop("volume", t.volume) : i.prop("volume", 0), t.fullscreen) {
    ...
    function(e) {
        Tilda.sendEventToStatistics = function(e, t, o, i) {
            o || (o = window.location.href), i = i ? parseFloat(i) : 0, window.ga && "tilda" != window.mainTracker && ga("send", {
                hitType: "pageview",
                page: e,
                title: t
